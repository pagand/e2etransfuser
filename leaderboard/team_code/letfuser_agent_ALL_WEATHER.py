...
#		cv2.imwrite('rgb.png', rgb)
	...
	def run_step(self, input_data, timestamp):
		...
		pred_seg, pred_wp, psteer, pthrottle, pbrake, predl, stop_sign, pred_sc, speed, _, _, _,_ = self.net(self.input_buffer['rgb'], self.input_buffer['depth'], target_point, gt_velocity,gt_command)
