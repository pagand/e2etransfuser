...
export SAVE_PATH=data1/new_data/transfuser_1img_NORMAL_long/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TM_PORT=2062 # port for traffic manager, required when spawning multiple servers/clients
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/other_transformer #_160 checkpoint for transfuser
