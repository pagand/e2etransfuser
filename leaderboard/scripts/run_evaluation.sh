...
export SAVE_PATH=data1/new_data/x13_1img_ADVERSARIAL_short_clear/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/x13/1.8/1img #_160 checkpoint for transfuser
