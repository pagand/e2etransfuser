...
export SAVE_PATH=data/NORMAL/AllWeather_short/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=${MODEL}/log/x13_18_1img #_160 checkpoint for transfuser
...
export TEAM_AGENT=leaderboard/team_code/x13_agent_allweather.py
