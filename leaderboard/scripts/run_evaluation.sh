...
export MODEL=transfuser #x13 transfuser geometric_fusion late_fusion aim cilrs s13 x13
export CONTROL_OPTION=160 #one_of both_must pid_only mlp_only, control option is only for s13 and x13 
export SAVE_PATH=data/NORMAL/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=${MODEL}/log/alldata_solar_160  #_160 checkpoint for transfuser
