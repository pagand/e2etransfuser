...
export SAVE_PATH=data1/new_data/Letfuser_with_attn_with_aug_2.3_NORMAL_long/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/LetFuser/2.3/with_attn_with_augmentation_2.3 #_160 checkpoint for transfuser
