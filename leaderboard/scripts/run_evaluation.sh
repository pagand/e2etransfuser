...
export WEATHER=WetNoon # ClearNoon, ClearSunset, CloudyNoon, CloudySunset, WetNoon, WetSunset, MidRainyNoon, MidRainSunset, WetCloudyNoon, WetCloudySunset, HardRainNoon, HardRainSunset, SoftRainNoon, SoftRainSunset
...
export TEAM_CONFIG=log/DMFUSER_novc #DMFUSER_nodist,  DMFUSER, DMFUSER_novc checkpoint for transfuser  #TODO change letfuser_agent.py to import LetFuser.model_nodist 
