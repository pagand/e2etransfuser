...
export SAVE_PATH=data1/NORMAL/${WEATHER}/Expert # ADVERSARIAL NORMAL
export ROUTES=leaderboard/data/all_routes/routes_town01_long.xml #lihat di /leaderboard/data/all_routes
export SCENARIOS=leaderboard/data/scenarios/town01_all_scenarios.json #look at leaderboard/data/scenarios town05_all_scenarios OR no_scenarios.json
