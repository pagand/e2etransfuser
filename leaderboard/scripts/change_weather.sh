...
export SAVE_PATH=data1/new_data/Letfuser_test_all_weather/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/LetFuser/1.8/with_attn_1.8 #_160 checkpoint for transfuser
export CHECKPOINT_ENDPOINT=${SAVE_PATH}/eval_result.json # results file
export TEAM_AGENT=leaderboard/team_code/${MODEL}_agent2.py
