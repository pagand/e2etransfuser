...
export SAVE_PATH=data1/new_data/transfuser_PAMI_ADVERSARIAL_short/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/transfuser_pami
