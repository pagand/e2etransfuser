...
export SAVE_PATH=data0/cvt_cnn_selfAttn_withAttn_Adv/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/models/cvt_cnn_selfAttn_withAttn
