...
export SAVE_PATH=data0/x13_long_NORMAL_prv/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TM_PORT=2076 # port for traffic manager, required when spawning multiple servers/clients
#export TEAM_CONFIG=/home/mohammad/Mohammad_ws/autonomous_driving/e2etransfuser/log/testmin_cvt_v2/retrain
export TEAM_CONFIG=/home/mohammad/Desktop/models/main/retrained1
