...
export SAVE_PATH=data1/new_data/Letfuser_with_attn_2.3_NORMAL_long_2/${WEATHER}/${MODEL}-${CONTROL_OPTION} # ADVERSARIAL NORMAL
...
export TEAM_CONFIG=/home/mohammad/Desktop/new_models/LetFuser/2.3/with_attn_2.3 #_160 checkpoint for transfuser
