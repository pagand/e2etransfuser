...
export MODEL=transfuser #x13 geometric_fusion late_fusion aim cilrs s13 x13
export CONTROL_OPTION=one_of2 #one_of both_must pid_only mlp_only, control option is only for s13 and x13 
...
export TEAM_CONFIG=${MODEL}/log/transfuser_3img_1.8 #_160 checkpoint for transfuser
