...
#                        (self.save_path / 'segmentation_right').mkdir()
	...
	def tick(self, input_data):
		...
		if self.config.input_resolution[1]==160:
			for pos in ['front']:  # only 'front'  for 1 image,  [ 'left','front','right'] for 3 images
				rgb_cam = 'rgb_' + pos
				...
				rgb.append(rgb_pos)
		elif self.config.input_resolution[1]==768:
			...
			print("input resolution is wrong!")
